...
;(function () {
   ...
   */
  EditorUi.compactUi =
    Editor.currentTheme != 'atlas' || window.DRAWIO_PUBLIC_BUILD
  ...
  EditorUi.enableDrafts =
    !mxClient.IS_CHROMEAPP && isLocalStorage && urlParams['drafts'] != '0'
    ...
    if (message != null) {
      ...
      severity =
        severity != null
          ...
          : message.indexOf('NetworkError') < 0 &&
            ...
            message.indexOf('NS_ERROR_FAILURE') < 0 &&
            message.indexOf('out of memory') < 0
          ? 'SEVERE'
          : 'CONFIG'
      ...
      try {
        if (
          EditorUi.enableLogging &&
          urlParams['dev'] != '1' &&
          message != EditorUi.lastErrorMessage &&
          message.indexOf('extension:') < 0 &&
          message.indexOf(
            'ResizeObserver loop completed with undelivered notifications'
          ) < 0 &&
          err.stack.indexOf('extension:') < 0 &&
          err.stack.indexOf('<anonymous>:') < 0 &&
          ...
          var img = new Image()
          var logDomain =
            window.DRAWIO_LOG_URL != null ? window.DRAWIO_LOG_URL : ''
          img.src =
            logDomain +
            '/log?severity=' +
            severity +
            '&v=' +
            encodeURIComponent(EditorUi.VERSION) +
            '&msg=clientError:' +
            ...
            (err.stack != '' ? '&stack=' + encodeURIComponent(err.stack) : '')
        }
      } catch (e) {
        // ignore
      }
   ...
   */
  EditorUi.prototype.defaultCustomShapeStyle =
  ...
  ;(function () {
    ...
    try {
      ...
      EditorUi.prototype.canvasSupported = !!(
        cnv.getContext && cnv.getContext('2d')
      )
    } catch (e) {
      // ignore
    }
    ...
    try {
      ...
      img.onload = function () {
        try {
          ...
          EditorUi.prototype.useCanvasForExport =
            result != null && result.length > 6
        } catch (e) {
          // ignore
        }
      }
      ...
      var svg =
        '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1px" height="1px" version="1.1"><foreignObject pointer-events="all" width="1" height="1"><div xmlns="http://www.w3.org/1999/xhtml"></div></foreignObject></svg>'
      img.src =
  ...
  EditorUi.prototype.isStandaloneApp = function () {
    return (
      mxClient.IS_CHROMEAPP || EditorUi.isElectronApp || this.isOfflineApp()
    )
  }
  ...
  EditorUi.prototype.isOffline = function (ignoreStealth) {
    return (
      ...
      !navigator.onLine ||
      (!ignoreStealth &&
        (urlParams['stealth'] == '1' || urlParams['lockdown'] == '1'))
    )
  }
  ...
  EditorUi.prototype.isExternalDataComms = function () {
    return (
      urlParams['offline'] != '1' && !this.isOffline() && !this.isOfflineApp()
    )
  }
  ...
  EditorUi.prototype.isVisioData = function (data) {
    return (
      ...
      ((data.charCodeAt(0) == 0xd0 &&
        ...
        data.charCodeAt(4) == 0xa1 &&
        data.charCodeAt(5) == 0xb1 &&
        data.charCodeAt(6) == 0x1a &&
        data.charCodeAt(7) == 0xe1) ||
  ...
  EditorUi.prototype.isRemoteVisioData = function (data) {
    return (
      ...
      ((data.charCodeAt(0) == 0xd0 &&
        ...
        data.charCodeAt(6) == 0x1a &&
        data.charCodeAt(7) == 0xe1) ||
        (data.charCodeAt(0) == 0x3c &&
          data.charCodeAt(1) == 0x3f &&
          data.charCodeAt(2) == 0x78 &&
          data.charCodeAt(3) == 0x6d &&
          data.charCodeAt(3) == 0x6c))
    )
  }
   ...
   */
  var editorUiExtractGraphModelFromHtml =
    EditorUi.prototype.extractGraphModelFromHtml
    ...
    if (data != null && data.length > 0) {
      ...
      if (index >= 0) {
        ...
        data =
          data.slice(0, index) +
          replaceString +
          data.slice(index + replaceStrLen - 1, data.length)
      }
      ...
      try {
        ...
        if (
          ...
          for (var i = nodes.length - 1; i >= 0; i--) {
            ...
            graph.model.execute(
              new ChangePage(this, page, i == 0 ? page : null, 0)
            )
          }
        } else {
          ...
          if (this.fileNode == null) {
            ...
            graph.model.execute(
              new ChangePage(this, this.currentPage, this.currentPage, 0)
            )
          }
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.createFileData = function (
    node,
    graph,
    file,
    url,
    ...
    uncompressed =
      uncompressed != null ? uncompressed : !Editor.defaultCompressed
    ...
    if (node == null) {
      ...
      if (!compact) {
        ...
        if (
          fileNode.getElementsByTagName('diagram').length > 1 &&
          this.pages != null
        ) {
      ...
      var xml = uncompressed
        ? mxUtils.getPrettyXml(fileNode)
        : mxUtils.getXml(fileNode)

      // Writes the file as an embedded HTML file
      if (
        !forceSvg &&
        !forceXml &&
        (forceHtml || (file != null && /(\.html)$/i.test(file.getTitle())))
      ) {
        xml = this.getHtml2(
          mxUtils.getXml(fileNode),
          graph,
        ...
        for (var i = 0; i < this.pages.length; i++) {
          ...
          if (page != this.currentPage) {
            if (page.needsUpdate) {
              ...
              if (page.viewState.backgroundImage != null) {
                if (page.viewState.backgroundImage.originalSrc != null) {
                  page.viewState.backgroundImage = this.createImageForPageLink(
                    page.viewState.backgroundImage.originalSrc,
                    page
                  )
                } else if (
                  Graph.isPageLink(page.viewState.backgroundImage.src)
                ) {
                  page.viewState.backgroundImage = this.createImageForPageLink(
                    page.viewState.backgroundImage.src,
                    page
                  )
                }
              }
              ...
              if (
                page.viewState.backgroundImage != null &&
      ...
      for (var i = 0; i < patch[EditorUi.DIFF_INSERT].length; i++) {
        try {
          ...
          if (clone.getAttribute('name') != null) {
            clone.setAttribute(
              'name',
              this.anonymizeString(clone.getAttribute('name'))
            )
          }
    ...
    for (var i = 0; i < nodes.length; i++) {
      if (nodes[i].getAttribute('value') != null) {
        nodes[i].setAttribute(
          'value',
          '[' + nodes[i].getAttribute('value').length + ']'
        )
      }
      ...
      if (nodes[i].getAttribute('xmlValue') != null) {
        nodes[i].setAttribute(
          'xmlValue',
          '[' + nodes[i].getAttribute('xmlValue').length + ']'
        )
      }
  ...
  EditorUi.prototype.synchronizeCurrentFile = function (forceReload) {
    ...
    if (currentFile != null) {
      if (currentFile.savingFile) {
        ...
        this.spinner.spin(document.body, mxResources.get('updatingDocument'))
      ) {
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.getFileData = function (
    forceXml,
    forceSvg,
    forceHtml,
    embeddedCallback,
    ...
    if (
      ...
      var darkTheme =
        graph.themes != null && graph.defaultThemeName == 'darkTheme'
      ...
      if (
        darkTheme ||
        (this.pages != null && this.currentPage != this.pages[0])
      ) {
    ...
    var result = this.createFileData(
      node,
      graph,
      file,
   ...
   *
   */
  EditorUi.prototype.getHtml = function (
    node,
    graph,
    title,
    editLink,
    ...
    return (
      ...
      (redirect == null
        ? title != null
          ? '<title>' + mxUtils.htmlEntities(title) + '</title>\n'
          : ''
        : '<title>draw.io</title>\n') +
      (redirect != null
        ...
        : '') +
      '</head>\n<body' +
      (redirect == null && bg != null && bg != mxConstants.NONE
   ...
   */
  EditorUi.prototype.getHtml2 = function (
    xml,
    graph,
    title,
    editLink,
    ...
    var js =
      window.DRAWIO_VIEWER_URL || EditorUi.drawHost + '/js/viewer-static.min.js'
  ...
  EditorUi.prototype.setFileData = function (data) {
    ...
    var cause = Editor.extractParserError(
      node,
    ...
    if (cause) {
      EditorUi.debug(
        'EditorUi.setFileData ParserError',
        [this],
        'data',
        [data],
        'node',
          ...
          this.currentPage =
            selectedPage != null
              ...
              : this.pages[
                  Math.max(
                    0,
                    Math.min(this.pages.length - 1, urlParams['page'] || 0)
                  )
                ]
  ...
  EditorUi.prototype.getBaseFilename = function (ignorePageName) {
    ...
    if (
      ...
      this.pages.length > 1 &&
      this.currentPage != null &&
      this.currentPage.node.getAttribute('name') != null &&
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.downloadFile = function (
    format,
    uncompressed,
    addShadow,
    ignoreSelection,
    ...
    try {
      ...
      var filename =
        basename +
        (format == 'xml' || (format == 'pdf' && includeXml) ? '.drawio' : '') +
        '.' +
        format
      ...
      if (format == 'xml') {
        ...
        (format == 'svg' || format == 'xmlsvg') &&
        this.spinner.spin(document.body, mxResources.get('export'))
      ) {
        var svg = null
        ...
        if (format == 'svg') {
          ...
          this.editor.convertImages(
            svgRoot,
            mxUtils.bind(
              this,
              mxUtils.bind(this, function (svgRoot2) {
                this.spinner.stop()
        ...
        this.saveRequest(
          filename,
          format,
          mxUtils.bind(this, function (newTitle, base64) {
            try {
  ...
  EditorUi.prototype.createDownloadRequest = function (
    filename,
    format,
    ignoreSelection,
    base64,
    ...
    var params = this.downloadRequestBuilder(
      filename,
      format,
      ignoreSelection,
      base64,
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.downloadRequestBuilder = function (
    filename,
    format,
    ignoreSelection,
    base64,
    ...
    var data = this.getFileData(
      ...
      null,
      ignoreSelection,
      currentPage == false ? false : format != 'xmlpng',
      null,
      null,
      null,
    ...
    if (
      !EditorUi.isElectronApp &&
      (bounds.width * bounds.height > MAX_AREA ||
        data.length > MAX_REQUEST_SIZE)
    ) {
  ...
  EditorUi.prototype.loadDescriptor = function (desc, success, error) {
    ...
    var loadData = mxUtils.bind(this, function (data) {
      ...
      var xml =
        desc.format != 'csv' && realData.length > 0
          ? realData
          : this.emptyDiagramXml
      var tempFile = new LocalFile(
        this,
        xml,
      ...
      if (desc.update != null) {
        ...
        var doUpdate = mxUtils.bind(this, function () {
          ...
          mxUtils.post(
            desc.update,
            'xml=' +
              encodeURIComponent(mxUtils.getXml(this.editor.getGraphXml())),
            mxUtils.bind(this, function (req) {
              if (page === this.currentPage) {
                if (req.getStatus() >= 200 && req.getStatus() <= 300) {
                  ...
                  this.handleError({
                    message: mxResources.get('error') + ' ' + req.getStatus()
                  })
                }
              }
            }),
        ...
        try {
          ...
          while (node != null) {
            if (node.nodeName == 'update') {
              ...
              while (
                dataNode != null &&
                dataNode.nodeType != mxConstants.NODETYPE_ELEMENT
              ) {
              ...
              if (node.hasAttribute('dx') || node.hasAttribute('dy')) {
                graph.view.translate = new mxPoint(
    ...
    if (file != null) {
      try {
        ...
        var fn = mxUtils.bind(this, function () {
          ...
          if (
            urlParams['url'] != null &&
            this.spinner.spin(document.body, mxResources.get('reconnecting'))
          ) {
        ...
        ((hash << 5) -
          ...
          this.hashValue(
            ...
            function (obj, key, value, isXml) {
              ...
              if (
                isXml &&
                (obj.nodeName == 'mxGeometry' || obj.nodeName == 'mxPoint') &&
    ...
    if (
      ...
      if (obj.attributes != null) {
        ...
        for (var i = 0; i < obj.attributes.length; i++) {
          ...
          var value =
            replacer != null
              ? replacer(obj, key, obj.attributes[i].value, true)
              : obj.attributes[i].value

          if (value != null) {
            hash =
              hash ^
              (this.hashValue(key, replacer, details) +
      ...
      if (obj.childNodes != null) {
        for (var i = 0; i < obj.childNodes.length; i++) {
          hash =
            ((hash << 5) -
              hash +
              this.hashValue(obj.childNodes[i], replacer, details)) <<
            0
        }
      }
  ...
  EditorUi.prototype.repositionLibrary = function (nextChild, append) {
    ...
    if (!this.sidebar.appendCustomLibraries || nextChild != null || !append) {
      if (nextChild == null) {
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.libraryLoaded = function (
    file,
    images,
    optionalTitle,
    expand
    ...
    var contentDiv = this.sidebar.addPalette(
      file.getHash(),
      tmp,
    ...
    if (file.isEditable()) {
      ...
      var addCells = mxUtils.bind(this, function (cells, bounds, evt, title) {
        cells = graph.cloneCells(
          mxUtils.sortCells(graph.model.getTopmostCells(cells))
        )
      ...
      mxEvent.addGestureListeners(
        ...
        mxUtils.bind(this, function (evt) {
          if (
            ...
            contentDiv.style.backgroundColor = Editor.isDarkMode()
              ? '#000000'
              : '#fefefe'
                ...
                mxUtils.bind(
                  ...
                  function (data, mimeType, x, y, w, h, img, doneFn, file) {
                    if (data != null && mimeType.substring(0, 6) == 'image/') {
                      ...
                      var cells = [
                        new mxCell('', new mxGeometry(0, 0, w, h), style)
                      ]
                      cells[0].vertex = true

                      addCells(
                        cells,
                        new mxRectangle(0, 0, w, h),
                        evt,
                        mxEvent.isAltDown(evt)
                          ? null
                          : img
                      ...
                      var doImport = mxUtils.bind(
                        this,
                        function (theData, theMimeType) {
                          if (
                            theData != null &&
                            theMimeType == 'application/pdf'
                          ) {
                          ...
                          if (theData != null) {
                            //Try to parse the file as xml (can be a library or mxfile). Otherwise, an error will be shown
                            ...
                            if (doc.documentElement.nodeName == 'mxlibrary') {
                              ...
                              try {
                                ...
                                for (var i = 0; i < pages.length; i++) {
                                  var cells = this.stringToCells(
                                    Editor.getDiagramNodeXml(pages[i])
                                  )
                                  var size =
                                    this.editor.graph.getBoundingBoxFromGeometry(
                                      cells
                                    )
                      ...
                      if (
                        ...
                        this.isRemoteFileFormat(data, img) &&
                        file != null
                      ) {
  ...
  EditorUi.prototype.addLibraryEntries = function (imgs, content) {
    for (var i = 0; i < imgs.length; i++) {
      try {
        ...
        var elt = this.sidebar.createVertexTemplateFromCells(
          null,
          img.w,
          img.h,
  ...
  EditorUi.initTheme = function () {
    if (Editor.currentTheme == 'atlas' && !window.DRAWIO_PUBLIC_BUILD) {
      ...
      if (typeof Toolbar !== 'undefined') {
        Toolbar.prototype.unselectedBackground =
          'linear-gradient(rgb(255, 255, 255) 0px, rgb(242, 242, 242) 100%)'
   ...
   * Overrides image dialog to add image search and Google+.
   */
  EditorUi.prototype.showLocalStorageDialog = function (
    title,
    key,
    buttons,
    elt,
    ...
    var dlg = new TextareaDialog(
      this,
      title,
      value != null ? JSON.stringify(JSON.parse(value), null, 2) : '',
   ...
   */
  EditorUi.prototype.showBackgroundImageDialog = function (
    apply,
    img,
    color,
    showColor
   ...
   * Hides the current menu.
   */
  EditorUi.prototype.showLibraryDialog = function (
    name,
    sidebar,
    images,
    file,
  ...
  EditorUi.prototype.handleError = function (
    ...
    if (
      resp != null &&
      (urlParams['test'] == '1' || resp.stack != null) &&
      resp.message != null
    ) {
      try {
        if (!disableLogging) {
          EditorUi.logError(
            'Caught: ' + (resp.message == '' && resp.name != null)
              ? resp.name
              : resp.message,
            resp.filename,
            resp.lineNumber,
        ...
        if (
          (urlParams['test'] == '1' || disableLogging) &&
          window.console != null
        ) {
      ...
      if (e != null) {
        ...
        if (e.code == 404 || e.status == 404 || e.code == 403) {
            ...
            msg =
              notFoundMessage != null
                ...
                : mxUtils.htmlEntities(
                    mxResources.get('fileNotFoundOrDenied') +
          ...
          if (
            ...
            (id.substring(0, 2) == '#G' ||
              id.substring(0, 45) ==
                '#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D') &&
            ((resp != null &&
              resp.error != null &&
              ((resp.error.errors != null &&
                resp.error.errors.length > 0 &&
                resp.error.errors[0].reason == 'fileAccess') ||
                (resp.error.data != null &&
                  resp.error.data.length > 0 &&
            ...
            id =
              id.substring(0, 2) == '#U'
                ? id.substring(45, id.lastIndexOf('%26ex'))
                : id.substring(2)
            ...
            this.showError(
              title,
              msg,
              mxResources.get('tryOpeningViaThisPage'),
              mxUtils.bind(this, function () {
                this.editor.graph.openLink(
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.confirm = function (
    msg,
    okFn,
    cancelFn,
    okLabel,
   ...
   */
  EditorUi.prototype.showBanner = function (
    id,
    text,
    onclick,
    doNotShowAgainOnClose,
    small,
    positionCss,
    t1,
    t2,
    ...
    if (
      ...
      var css = !small
        ? 'font-size:16px;padding:18px 34px 12px 20px;font-weight:bold;'
      ...
      if (!small) {
        ...
        img.setAttribute(
          'title',
          mxResources.get(doNotShowAgainOnClose ? 'doNotShowAgain' : 'close')
        )
        img.setAttribute('border', '0')
        img.style.cssText =
          (small ? 'right:6px;top:9px;' : 'right:10px;top:12px;') +
          'position:absolute;filter:invert(1);padding:6px;margin:-6px;cursor:default;'
  ...
  EditorUi.prototype.createImageDataUri = function (canvas, xml, format, dpi) {
    ...
    if (data != null && data.length > 6) {
      if (xml != null) {
        data = Editor.writeGraphModelToPng(
          data,
          'tEXt',
          'mxfile',
   ...
   *
   */
  EditorUi.prototype.saveCanvas = function (
    canvas,
    xml,
    format,
    ignorePageName,
    ...
    var filename =
      this.getBaseFilename(ignorePageName) +
      (xml != null ? '.drawio' : '') +
      '.' +
      ext
  ...
  EditorUi.prototype.doSaveLocalFile = function (
    ...
    // Older versions of IE (binary not supported)
      ...
      if (useDownload || this.isOffline()) {
        ...
        var req = this.createEchoRequest(
          data,
          filename,
          mimeType,
          base64Encoded,
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.createEchoRequest = function (
    data,
    filename,
    mimeType,
    base64Encoded,
  ...
  EditorUi.prototype.saveLocalFile = function (
    ...
    allowTab =
      allowTab != null
        ? allowTab
        : format != 'vsdx' && (!mxClient.IS_IOS || !navigator.standalone)

    var saveFunction = mxUtils.bind(
      this,
      function (newTitle, mode, input, folderId) {
        try {
          // Opens a new window
          if (mode == '_blank') {
            if (mimeType != null && mimeType.substring(0, 6) == 'image/') {
              ...
              mimeType != null &&
              mimeType.substring(0, 9) == 'text/html'
            ) {
              ...
              if (win == null) {
                ...
                win.document.write(
                  '<pre>' + mxUtils.htmlEntities(data, false) + '</pre>'
                )
                win.document.close()
              }
            }
    ...
    // 直接下载
    saveFunction(window.VueVm.fileName, 'download', null, '')
    return
   ...
   *
   */
  EditorUi.prototype.openInNewWindow = function (
    data,
    mimeType,
    base64Encoded
  ) {
    ...
    if (win == null || win.document == null) {
      ...
      if (mimeType == 'image/svg+xml' && !mxClient.IS_SVG) {
        win.document.write(
          '<html><pre>' + mxUtils.htmlEntities(data, false) + '</pre></html>'
        )
        win.document.close()
      } else {
        if (mimeType == 'image/svg+xml' && !base64Encoded) {
          ...
          var temp = base64Encoded
            ? data
            : btoa(unescape(encodeURIComponent(data)))

          win.document.write(
            '<html><img style="max-width:100%;" src="data:' +
              mimeType +
              ';base64,' +
              temp +
              '"/></html>'
  ...
  var editoUiAddChromelessToolbarItems =
    EditorUi.prototype.addChromelessToolbarItems
  ...
  EditorUi.prototype.addChromelessToolbarItems = function (addButton) {
    if (urlParams['tags'] != null) {
      ...
      var tagsButton = addButton(
        mxUtils.bind(this, function (evt) {
          if (this.tagsComponent == null) {
            this.tagsComponent = this.editor.graph.createTagsDialog(
              mxUtils.bind(this, function () {
            ...
            this.tagsComponent.div.getElementsByTagName(
              'div'
            )[0].style.position = ''
            mxUtils.setPrefixedStyle(
              this.tagsComponent.div.style,
              'borderRadius',
              '5px'
            )
      ...
      var exportButton = addButton(
        mxUtils.bind(this, function (evt) {
          ...
          if (this.exportDialog != null) {
            ...
            this.exportDialog.style.bottom =
              parseInt(this.chromelessToolbar.style.bottom) +
              this.chromelessToolbar.offsetHeight +
              4 +
              'px'
            ...
            this.editor.exportToCanvas(
              ...
              mxUtils.bind(this, function (e) {
                ...
                if (
                  this.exportDialog != null &&
                  this.exportDialog.parentNode != null
                ) {
                  this.exportDialog.parentNode.removeChild(this.exportDialog)
                  this.exportDialog = null
                }
   ...
   * @param {number} dy Y-coordinate of the translation.
   */
  EditorUi.prototype.saveData = function (
    filename,
    format,
    data,
    mime,
  ...
  EditorUi.prototype.saveRequest = function (
    ...
    allowTab =
      allowTab != null ? allowTab : !mxClient.IS_IOS || !navigator.standalone
    ...
    var dlg = new SaveDialog(
      ...
      mxUtils.bind(this, function (input, mode, folderId) {
        console.log(
          'input.value, mode, input, folderId',
          input.value,
          mode,
          input,
          folderId
   ...
   * Hook for subclassers.
   */
  EditorUi.prototype.exportFile = function (
    data,
    filename,
    mimeType,
    base64Encoded,
   ...
   *
   */
  EditorUi.prototype.exportSvg = function (
    scale,
    ...
    if (
      ...
      try {
        ...
        ignoreSelection =
          ignoreSelection != null ? ignoreSelection : selectionEmpty
        ...
        if (bg == null && transparentBackground == false) {
          bg =
            theme == 'dark' && !Editor.enableCssDarkMode
              ? Editor.darkColor
              : '#ffffff'
        }

        // Removes global foreignObject warning if image fallback is added for text
        var graphAddForeignObjectWarning =
          this.editor.graph.addForeignObjectWarning
        ...
        var filename =
          this.getBaseFilename() + (editable ? '.drawio' : '') + '.svg'
   ...
   * the images to be supported in apps like Powerpoint.
   */
  EditorUi.prototype.replaceAlternateContent = function (
    root,
    theme,
    callback
  ) {
    ...
    function replaceElt(switchElt, x, y, size, src) {
      var node = mxUtils.createElementNs(
        root.ownerDocument,
        mxConstants.NS_SVG,
        'image'
      )
      ...
      mxUtils.bind(this, function (switchElt) {
        ...
        if (divs.length > 0) {
          try {
            ...
            if (temp.style.width == '1px') {
              if (
                (!vertical && justifyContent == 'unsafe center') ||
                (vertical && alignItems == 'unsafe center')
              ) {
                x -= size.width / 2
              } else if (
                (!vertical && justifyContent == 'unsafe flex-end') ||
                (vertical &&
                  ((!rl && alignItems == 'unsafe flex-end') ||
            ...
            convert.push(
              mxUtils.bind(this, function (next) {
                ...
                if (cachedSrc == null) {
                  Graph.htmlToPng(
                    ...
                    size.width,
                    size.height,
                    mxUtils.bind(this, function (src) {
   ...
   *
   */
  EditorUi.prototype.addRadiobox = function (
    div,
    radioGroupName,
    label,
    checked,
   ...
   *
   */
  EditorUi.prototype.addCheckbox = function (
    div,
    label,
    checked,
    disabled,
  ...
  EditorUi.prototype.addLinkSection = function (div, showFrameOption) {
    ...
    linkButton.style.top =
      mxClient.IS_IE || mxClient.IS_IE11 || mxClient.IS_EDGE ? '6px' : '1px'
   ...
   *
   */
  EditorUi.prototype.createUrlParameters = function (
    linkTarget,
    linkColor,
    allPages,
    lightbox,
    ...
    if (lightbox) {
      if (
        EditorUi.lightboxHost != 'https://viewer.diagrams.net' ||
        urlParams['dev'] == '1'
      ) {
      ...
      if (linkColor != null && linkColor != mxConstants.NONE) {
        params.push(
          'highlight=' +
            (linkColor.charAt(0) == '#' ? linkColor.substring(1) : linkColor)
        )
      }
  ...
  EditorUi.prototype.createLink = function (
    ...
    return (
      (lightbox && urlParams['dev'] != '1'
        ? EditorUi.lightboxHost
   ...
   *
   */
  EditorUi.prototype.createHtml = function (
    publicUrl,
    zoomEnabled,
    initialZoom,
    linkTarget,
    ...
    var fetchParam =
      publicUrl != null ? '&fetch=' + encodeURIComponent(publicUrl) : ''
    var s2 =
      fetchParam.length > 0
        ? (urlParams['dev'] == '1'
            ? 'https://test.draw.io/embed2.js?dev=1'
            : EditorUi.lightboxHost + '/embed2.js?') + fetchParam
        : urlParams['dev'] == '1'
        ? 'https://test.draw.io/js/viewer-static.min.js'
        : window.DRAWIO_VIEWER_URL
        ? window.DRAWIO_VIEWER_URL
        : EditorUi.lightboxHost + '/js/viewer-static.min.js'
   ...
   *
   */
  EditorUi.prototype.showHtmlDialog = function (
    btnLabel,
    helpLink,
    publicUrl,
    fn
    ...
    hd.style.cssText =
      'width:100%;text-align:center;margin-top:0px;margin-bottom:12px'
    div.appendChild(hd)

    var radioSection = document.createElement('div')
    radioSection.style.cssText =
      'border-bottom:1px solid lightGray;padding-bottom:8px;margin-bottom:12px;'

    var publicUrlRadio = document.createElement('input')
    publicUrlRadio.style.cssText =
    ...
    if (
      publicUrl == null &&
      file != null &&
      file.constructor == window.DriveFile
    ) {
    ...
    var allPages = (allPages = this.addCheckbox(
      div,
    ...
    var dlg = new CustomDialog(
      ...
      mxUtils.bind(this, function () {
        fn(
          publicUrlRadio.checked ? publicUrl : null,
          zoom.checked,
          zoomInput.value,
          linkSection.getTarget(),
          linkSection.getColor(),
          fit.checked,
          allPages.checked,
          layers.checked,
          tags.checked,
          lightbox.checked,
          editSection != null ? editSection.getLink() : null
        )
      }),
      null,
      btnLabel,
  ...
  EditorUi.prototype.showPublishLinkDialog = function (
    ...
    if (file != null && file.constructor == window.DriveFile && !hideShare) {
      ...
      helpLink =
        helpLink != null
          ? helpLink
          : 'https://www.drawio.com/doc/faq/google-drive-publicly-publish-diagram'
      var hintSection = document.createElement('div')
      hintSection.style.cssText =
        'border-bottom:1px solid lightGray;padding-bottom:14px;padding-top:6px;margin-bottom:14px;text-align:center;'
            ...
            this.getPublicUrl(
              ...
              mxUtils.bind(this, function (url) {
                ...
                var dlg = new ErrorDialog(
                  ...
                  null,
                  mxResources.get(
                    url != null ? 'diagramIsPublic' : 'diagramIsNotPublic'
                  ),
                  mxResources.get('ok')
                )
      ...
      helpLink =
        helpLink != null
          ? helpLink
          : 'https://www.drawio.com/doc/faq/publish-diagram-as-link'
    }
   ...
   *
   */
  EditorUi.prototype.showRemoteExportDialog = function (
    btnLabel,
    helpLink,
    callback,
    hideInclude,
    ...
    hd.style.cssText =
      'width:100%;text-align:center;margin-top:0px;margin-bottom:' +
      (showZoomBorder ? '10' : '4') +
      'px'
    div.appendChild(hd)
    ...
    var selection = this.addCheckbox(
      div,
      mxResources.get('selectionOnly'),
      false,
      this.editor.graph.isSelectionEmpty()
    )
    var include = hideInclude
      ? null
      : this.addCheckbox(
          div,
          mxResources.get('includeCopyOfMyDiagram'),
          Editor.defaultIncludeDiagram
        )

    var graph = this.editor.graph
    var transparent = hideInclude
      ? null
      : this.addCheckbox(
          div,
          mxResources.get('transparentBackground'),
    ...
    var dlg = new CustomDialog(
      ...
      mxUtils.bind(this, function () {
        ...
        callback(
          !selection.checked,
          include != null ? include.checked : false,
    ...
    this.showDialog(
      dlg.container,
      300,
      (showZoomBorder ? 25 : 0) + (hideInclude ? 125 : 210),
      true,
      true
    )
  }
   ...
   *
   */
  EditorUi.prototype.showExportDialog = function (
    title,
    embedOption,
    btnLabel,
    helpLink,
    ...
    defaultInclude =
      defaultInclude != null ? defaultInclude : Editor.defaultIncludeDiagram
    ...
    hd.style.cssText =
      'width:100%;text-align:center;margin-top:0px;margin-bottom:10px'
    div.appendChild(hd)
    ...
    var transparent = this.addCheckbox(
      div,
      mxResources.get('transparentBackground'),
      defaultTransparent,
      null,
    ...
    if (format == 'png' || format == 'jpeg' || format == 'webp') {
      grid = this.addCheckbox(
        div,
        mxResources.get('grid'),
        false,
        this.isOffline() || !this.canvasSupported,
        false,
        true
      )
      height += 30
    ...
    if (embedOption) {
      cb5.checked = this.lastEmbedImages != null ? this.lastEmbedImages : true
      div.appendChild(cb5)
      mxUtils.write(div, mxResources.get('embedImages'))
      mxUtils.br(div)

      cb7.checked = this.lastEmbedFonts != null ? this.lastEmbedImages : true
      div.appendChild(cb7)
   ...
   *
   */
  EditorUi.prototype.showEmbedImageDialog = function (
    fn,
    title,
    imageLabel,
    shadowEnabled,
    ...
    var shadow = this.addCheckbox(
      div,
      mxResources.get('shadow'),
      graph.shadowVisible && shadowEnabled,
      !shadowEnabled
    )
   ...
   *
   */
  EditorUi.prototype.createEmbedImage = function (
    fit,
    shadow,
    retina,
    lightbox,
    ...
    function doUpdate(dataUri) {
      ...
      if (lightbox) {
        ...
        onclick =
          " onclick=\"(function(img){if(img.wnd!=null&&!img.wnd.closed){img.wnd.focus();}else{var r=function(evt){if(evt.data=='ready'&&evt.source==img.wnd){img.wnd.postMessage(decodeURIComponent(" +
          "img.getAttribute('src')),'*');window.removeEventListener('message',r);}};window.addEventListener('message',r);img.wnd=window.open('" +
          EditorUi.lightboxHost +
          '/?client=1' +
          (page != null ? '&page=' + page : '') +
          (edit ? '&edit=_blank' : '') +
    ...
    if (this.isExportToCanvas()) {
      ...
      if (
        ...
        if (retina) {
          size =
            '&w=' +
            Math.round(2 * bounds.width) +
            '&h=' +
            Math.round(2 * bounds.height)
        }
   ...
   *
   */
  EditorUi.prototype.createEmbedSvg = function (
    fit,
    shadow,
    image,
    lightbox,
    ...
    if (image) {
      ...
      this.editor.convertImages(
        ...
        mxUtils.bind(this, function (svgRoot) {
          fn(
            '<img src="' +
              Editor.createSvgDataUri(mxUtils.getXml(svgRoot)) +
              '"' +
              (css != '' ? ' style="' + css + '"' : '') +
              onclick +
              '/>'
      ...
      if (lightbox) {
        ...
        // KNOWN: Message passing does not seem to work in IE11
        var js =
          '(function(svg){var src=window.event.target||window.event.srcElement;' +
          // Ignores link events
   ...
   *
   */
  EditorUi.prototype.getEmbeddedPng = function (
    success,
    error,
    optionalData,
    scale,
    ...
    try {
      ...
      if (optionalData != null && optionalData.length > 0) {
        ...
        document.body.appendChild(graph.container)
        this.decodeNodeIntoGraph(
          this.editor.extractGraphModel(
            mxUtils.parseXml(optionalData).documentElement,
            true
          ),
          graph
        )
        ...
        mxUtils.bind(this, function (canvas) {
          try {
            ...
            data = Editor.writeGraphModelToPng(
              ...
              'tEXt',
              'mxfile',
              encodeURIComponent(diagramData)
            )
   ...
   */
  EditorUi.prototype.getEmbeddedSvg = function (
    xml,
    graph,
    url,
    noHeader,
   ...
   *
   */
  EditorUi.prototype.exportImage = function (
    scale,
    transparentBackground,
    ignoreSelection,
    addShadow,
        ...
        try {
          ...
          if (node != null && node.nodeName == 'mxfile' && this.pages != null) {
            ...
            if (diagrams.length == 1 && !addNewPage) {
              ...
              if (this.currentPage != null) {
                mapping[diagrams[0].getAttribute('id')] =
                ...
                if (this.isBlankFile()) {
                  ...
                  if (name != null && name != '') {
                    this.editor.graph.model.execute(
                      new RenamePage(this, this.currentPage, name)
                    )
                  }
                }
              }
              ...
              if (
                ...
                if (name != null && name != '') {
                  this.editor.graph.model.execute(
                    new RenamePage(this, this.pages[0], name)
                  )
                }
              ...
              for (var i = i0; i < diagrams.length; i++) {
                ...
                graph.model.execute(
                  new ChangePage(this, page, page, index, true)
                )
                pages.push(page)
              }
          ...
          if (node != null && node.nodeName === 'mxGraphModel') {
            ...
            var bgImg = graph.parseBackgroundImage(
          ...
          if (applyDefaultStyles) {
            graph.pasteCellStyles(
              graph.includeDescendants(cells),
  ...
  EditorUi.prototype.updatePageLinks = function (mapping, pages) {
    for (var i = 0; i < pages.length; i++) {
      ...
      if (pages[i].viewState != null) {
        this.updateBackgroundPageLink(
          mapping,
          pages[i].viewState.backgroundImage
        )
      }
    }
  }
  ...
  EditorUi.prototype.updateBackgroundPageLink = function (mapping, obj) {
    try {
      if (obj != null && Graph.isPageLink(obj.originalSrc)) {
        var newId =
          mapping[obj.originalSrc.substring(obj.originalSrc.indexOf(',') + 1)]
   ...
   */
  EditorUi.prototype.importVisio = function (
    file,
    done,
    error,
    filename,
    ...
    this.createTimeout(
      ...
      mxUtils.bind(this, function (timeout) {
            ...
            if (remote) {
              if (VSD_CONVERT_URL != null && !this.isOffline()) {
                ...
                xhr.open(
                  'POST',
                  VSD_CONVERT_URL +
                    (/(\.vss|\.vsx)$/.test(filename) ? '?stencil=1' : '')
                )
        ...
        if (
          ...
          mxscript(
            window.DRAWIO_SERVER_URL + 'js/extensions.min.js',
            delayed,
            null,
            null,
            null,
  ...
  EditorUi.prototype.convertLucidChart = function (data, success, error) {
    ...
    this.createTimeout(
      ...
      mxUtils.bind(this, function (timeout) {
        ...
        if (
          typeof window.LucidImporter === 'undefined' &&
          !this.loadingExtensions &&
          !this.isOffline(true)
        ) {
          this.loadingExtensions = true
  ...
  EditorUi.prototype.createMermaidXml = function (input, config, data, w, h) {
    ...
    graph.setAttributeForCell(
      cell,
      'mermaidData',
      JSON.stringify({ data: input, config: config }, null, 2)
    )
   ...
   * Generates a Mermaid image.
   */
  EditorUi.prototype.generateOpenAiMermaidDiagram = function (
    prompt,
    success,
    error
  ) {
                  ...
                  if (req.getStatus() >= 200 && req.getStatus() <= 299) {
                    this.tryAndHandle(
                      mxUtils.bind(this, function () {
                        ...
                        this.generateMermaidImage(
                          result,
                          null,
                          mxUtils.bind(this, function (data, w, h) {
                            this.tryAndHandle(
                              mxUtils.bind(this, function () {
                                if (timeout.clear()) {
                                  EditorUi.debug(
  ...
  EditorUi.prototype.extractMermaidDeclaration = function (value) {
    ...
    if (
      (lines.length > 0 && mxUtils.trim(lines[0]) == 'mermaid') ||
      (type != null && mxUtils.indexOf(EditorUi.mermaidDiagramTypes, type) >= 0)
    ) {
      lines.shift()
   ...
   * Generates a Mermaid image.
   */
  EditorUi.prototype.generateMermaidImage = function (
    data,
    config,
    success,
    error,
    ...
    var delayed = mxUtils.bind(this, function () {
      try {
        ...
        config =
          config != null ? config : mxUtils.clone(EditorUi.defaultMermaidConfig)
        ...
        var renderCallback = mxUtils.bind(this, function (svg) {
          try {
            ...
            if (mxClient.IS_IE || mxClient.IS_IE11) {
              svg = svg
                .replace(
                  / xmlns:\S*="http:\/\/www.w3.org\/XML\/1998\/namespace"/g,
                  ''
                )
                .replace(
                  / (NS xml|\S*):space="preserve"/g,
                  ' xml:space="preserve"'
                )
            }
            ...
            if (
              svgs.length > 0 &&
              svgs[0].getAttribute('aria-roledescription') != 'error'
            ) {
        ...
        mermaid.mermaidAPI
          .render('geMermaidOutput-' + new Date().getTime(), data)
    ...
    if (
      ...
      if (urlParams['dev'] == '1') {
        if (urlParams['mermaidToDrawioTest'] == '1') {
          mxMermaidToDrawio.addListener(
            mxUtils.bind(this, function (modelXml) {
   ...
   */
  EditorUi.prototype.generatePlantUmlImage = function (
    data,
    type,
    success,
    error
   ...
   */
  EditorUi.prototype.insertTextAt = function (
    text,
    dx,
    dy,
    html,
        ...
        if (this.isCompatibleString(text)) {
          ...
          if (this.isLucidChartData(text)) {
            this.convertLucidChart(
              ...
              mxUtils.bind(this, function (xml) {
                this.editor.graph.setSelectionCells(
                  this.importXml(xml, dx, dy, crop, null, addNewPage)
                )
              }),
              mxUtils.bind(this, function (e) {
                this.handleError(e)
            ...
            try {
              ...
              if (
                this.maxTextWidth > 0 &&
                cell.geometry.width > this.maxTextWidth
              ) {
                var size = graph.getPreferredSizeForCell(
                  cell,
                  this.maxTextWidth
                )
  ...
  EditorUi.prototype.isLucidChartData = function (data) {
    return (
      data != null &&
      (data.substring(0, 26) == '{"state":"{\\"Properties\\":' ||
  ...
  EditorUi.prototype.importLocalFile = function (device, noSplash) {
    if (device && Graph.fileSupport) {
      ...
      window.openBrowserFile = mxUtils.bind(
        this,
        function (title, success, error) {
          StorageFile.getFileContent(this, title, success, error)
        }
      )

      window.deleteBrowserFile = mxUtils.bind(
        this,
        function (title, success, error) {
      ...
      this.showDialog(
        ...
        Editor.useLocalStorage ? 640 : 360,
          ...
          function (zip) {
            if (mxUtils.isEmptyObject(zip.files)) {
              ...
              zip.forEach(function (relativePath, zipEntry) {
                ...
                if (name == 'diagram/diagram.xml') {
                  //draw.io zip format has the latest diagram version at diagram/diagram.xml
                  drawioFound = true
                ...
                } else if (name.indexOf('versions/') == 0) {
                  //Gliffy zip format has the versions inside versions folder
              ...
              if (gliffyLatestVer.version > 0) {
                gliffyLatestVer.zipEntry.async('string').then(function (data) {
                  if (
                    new XMLHttpRequest().upload &&
                    ui.isRemoteFileFormat(data, file.name)
                  ) {
                    if (ui.isOffline()) {
                      ui.showError(
                        mxResources.get('error'),
   ...
   * Imports the given XML into the existing diagram.
   */
  EditorUi.prototype.importFile = function (
    data,
    mimeType,
    dx,
    dy,
          ...
          if (xhr.readyState == 4) {
            if (xhr.status >= 200 && xhr.status <= 299) {
              ...
              this.showError(
                mxResources.get('error'),
                xhr.status == 413
                  ? mxResources.get('diagramTooLarge')
   ...
   *
   */
  EditorUi.prototype.importFiles = function (
    files,
    x,
    y,
    maxSize,
    ...
    if (!mxClient.IS_CHROMEAPP && files != null) {
      ...
      for (var i = 0; i < files.length; i++) {
        if (
          files[i].type.substring(0, 9) !== 'image/svg' &&
    ...
    var doImportFiles = mxUtils.bind(this, function () {
      ...
      fn =
        fn != null
          ...
          : mxUtils.bind(
              this,
              function (data, mimeType, x, y, w, h, filename, done, file) {
                try {
                                      ...
                                      if (
                                        ...
                                        img.onload = mxUtils.bind(
                                          ...
                                          function () {
                                            ...
                                            graph.setCellStyles('image', data, [
                                              cells[0]
                                            ])
                                          }
                                        )

                                        img.src = Editor.createSvgDataUri(
                                          mxUtils.getXml(svgRoot)
                                        )
                                      }
  ...
  EditorUi.prototype.isBlankFile = function () {
    return (
      ...
      this.pages.length == 1 &&
      this.isDiagramEmpty() &&
      this.currentPage.getName() == mxResources.get('pageWithNumber', [1])
    )
  }
  ...
  EditorUi.prototype.confirmImageResize = function (fn, force) {
    ...
    if (resizeImages != null && !force) {
      ...
      this.showDialog(
        ...
        340,
        isLocalStorage || mxClient.IS_CHROMEAPP ? 226 : 200,
        true,
        true
      )
    }
   ...
   */
  EditorUi.prototype.resizeImage = function (
    img,
    data,
    fn,
    enabled,
    ...
    if (
      enabled &&
      this.isResampleImageSize(
        fileSize != null ? fileSize : data.length,
        thresh
      )
    ) {
      try {
    ...
    if (
      enabled &&
      originalData != data &&
      maxSize > this.maxImageSize / 2 &&
      data.length > this.maxImageBytes
    ) {
  ...
  EditorUi.prototype.getDefaultSketchMode = function () {
    ...
    var roughParam =
      urlParams['rough'] != null ? urlParams['rough'] : defaultValue
  ...
  EditorUi.prototype.createUi = function () {
    if (Editor.isSettingsEnabled()) {
      ...
      if (
        (Editor.config == null || Editor.config.enableCssDarkMode == null) &&
    ...
    if (Editor.isSettingsEnabled()) {
      this.doSetSketchMode(
        mxSettings.settings.sketchMode != null &&
          urlParams['rough'] == null &&
          urlParams['sketch'] == null
          ? mxSettings.settings.sketchMode
          : this.getDefaultSketchMode()
      )
    }
  }
  ...
  EditorUi.prototype.init = function () {
                ...
                function (data, w, h) {
                  ...
                  try {
                    if (obj.format == 'txt') {
                      ...
                      graph.setCellStyles('image', ui.convertDataUri(data), [
                        cell
                      ])
      ...
      mxUtils.bind(this, function (sender, evt) {
        var ref =
          graph.backgroundImage != null
            ? graph.backgroundImage.originalSrc
            : null
        ...
        if (ref != null) {
          ...
          if (comma > 0) {
            ...
            for (var i = 0; i < patches.length; i++) {
              if (
                (patches[i][EditorUi.DIFF_UPDATE] != null &&
    ...
    graph.getBackgroundImageObject = function (obj, resolveReferences) {
      ...
      if (result != null && result.originalSrc != null) {
        if (!resolveReferences) {
          ...
          result = ui.createImageForPageLink(
            result.originalSrc,
            null,
            null,
            true
    ...
    if (
      /viewer\.diagrams\.net$/.test(window.location.hostname) ||
    ...
    if (mxClient.IS_SVG) {
      ...
      this.editor.graph.addSvgShadow(
        graph.view.canvas.ownerSVGElement,
        null,
        true
      )
    }
    ...
    if (this.menus != null) {
      ...
      this.menus.addPopupMenuItems = function (menu, cell, evt) {
        ...
        if (!graph.isSelectionEmpty() && ui.addSelectionToScratchpad != null) {
      ...
      this.menus.addPopupMenuEditItems = function (menu, cell, evt) {
        if (ui.editor.graph.isSelectionEmpty()) {
          ...
          this.addMenuItems(
            menu,
            ['-', 'cut', 'copy', 'copyAsImage', 'duplicate', '-'],
            null,
            evt
          )
    ...
    graph.getExportVariables = function () {
      ...
      vars['pagenumber'] =
        ui.pages != null && ui.currentPage != null
          ? mxUtils.indexOf(ui.pages, ui.currentPage) + 1
          : 1
    ...
    graph.labelLinkClicked = function (state, elt, evt) {
      ...
      if (
        ...
        if (
          !graph.isEnabled() ||
          (state != null && graph.isCellLocked(state.cell))
        ) {
            ...
            mxEvent.addListener(
              ...
              mxUtils.bind(this, function (evt) {
                ...
                if (evt.dataTransfer.files.length > 0) {
                  ...
                  mxUtils.indexOf(evt.dataTransfer.types, 'text/uri-list') >= 0
                ) {
                  ...
                  if (
                    mxUtils.indexOf(evt.dataTransfer.types, 'text/html') >= 0
                  ) {
                    document.execCommand(
                      'insertHTML',
                      false,
                    ...
                    mxUtils.indexOf(evt.dataTransfer.types, 'text/plain') >= 0
                  ) {
                    document.execCommand(
                      'insertHTML',
                      false,
    ...
    if (urlParams['styledev'] == '1') {
      ...
      if (footer != null) {
        ...
        this.editor.graph.getSelectionModel().addListener(
          mxEvent.CHANGE,
          mxUtils.bind(this, function (sender, evt) {
            ...
            if (files.length > 0) {
              ...
              var uri =
                mxUtils.indexOf(evt.dataTransfer.types, 'text/uri-list') >= 0
                  ...
                  : null
              var data = this.extractGraphModelFromEvent(
                evt,
                this.pages != null
              )
              ...
              if (data != null) {
                ...
                if (
                  asImage &&
                  html != null &&
                  html.length > this.resampleThreshold
                ) {
                  this.confirmImageResize(function (doResize) {
                    resizeImages = doResize
                    doInsert()
                ...
                uri != null &&
                /\.(gif|jpg|jpeg|tiff|png|svg)$/i.test(uri)
              ) {
                this.loadImage(
                  decodeURIComponent(uri),
                  mxUtils.bind(this, function (img) {
    ...
    mxWindow.prototype.fit = function () {
      if (!Editor.inlineFullscreen && ui.embedViewport != null) {
        ...
        this.div.style.left =
          Math.max(ui.embedViewport.x, Math.min(left, right - width)) + 'px'
        this.div.style.top =
          Math.max(ui.embedViewport.y, Math.min(top, bottom - height)) + 'px'
        this.div.style.height =
          Math.min(ui.embedViewport.height, parseInt(this.div.style.height)) +
          'px'
        this.div.style.width =
          Math.min(ui.embedViewport.width, parseInt(this.div.style.width)) +
          'px'
      } else {
    ...
    if (urlParams['high-contrast'] == '1') {
      ...
      Editor.isSettingsEnabled() &&
      !this.editor.graph.isLightboxView() &&
  ...
  EditorUi.prototype.initializeInlineEmbedMode = function () {
    ...
    mxEvent.addGestureListeners(
      this.diagramContainer.parentNode,
      mxUtils.bind(this, function (evt) {
      ...
      mxUtils.bind(this, function (evt) {
        ...
        if (x0 != null) {
          this.diagramContainer.style.width =
            Math.max(20, w0 + mxEvent.getClientX(evt) - x0) + 'px'
          changed = true
        }

        if (y0 != null) {
          this.diagramContainer.style.height =
            Math.max(20, h0 + mxEvent.getClientY(evt) - y0) + 'px'
          changed = true
        }
  ...
  EditorUi.prototype.doSetCurrentTheme = function (value, delay, post) {
    ...
    function isSimple(theme) {
      return theme == 'simple' || (delay == 0 && theme == 'sketch')
    }

    // From kennedy to simple or sketch or vice versa
    var curr = Editor.currentTheme
    var transition =
      (isSimple(curr) && this.isDefaultTheme(value)) ||
                  ...
                  window.setTimeout(
                    mxUtils.bind(this, function () {
                      ...
                      if (isLocalStorage && isSimple(value)) {
                        this.setTabContainerVisible(
                          mxSettings.settings.pages != null
                            ? mxSettings.settings.pages
                            : true
                        )
                      }
      ...
      if (Editor.currentTheme == 'sketch') {
        var elt =
          ...
          typeof this.statusContainer.firstChild.getAttribute === 'function'
            ? this.statusContainer.firstChild
            : null
        ...
        if (!visible && elt != null) {
          ...
          if (title == mxResources.get(key) + '...') {
            this.statusContainer.innerHTML =
              '<div><img title="' +
              mxUtils.htmlEntities(mxResources.get(key)) +
              '...' +
              '"src="' +
              Editor.tailSpin +
              '"></div>'
        ...
        parent.style.visibility =
          empty && this.editor.getStatus() == '' ? 'hidden' : ''
        ...
        this.statusContainer.style.display =
          this.statusContainer.clientWidth == 0 ? 'none' : 'inline-flex'
      } else {
        this.statusContainer.style.display = 'inline-flex'
      }
    })
  ...
  EditorUi.prototype.switchTheme = function (value) {
    ...
    if (this.isDefaultTheme(value)) {
      ...
      if (this.formatContainer != null) {
        ...
        if (this.footerContainer != null) {
          if (
            this.footerContainer.parentNode != this.formatContainer.parentNode
          ) {
        ...
        if (this.sidebarContainer != null) {
          if (
            this.formatContainer.parentNode != this.sidebarContainer.parentNode
          ) {
    ...
    if (value == 'sketch') {
      ...
      var libs =
        ...
        (urlParams['embed'] != '1' || urlParams['libraries'] == '1')
  ...
  EditorUi.prototype.createWrapperForTheme = function (value) {
    if (
      this.sketchWrapperElt != null &&
      this.sketchWrapperElt.parentNode != null
    ) {
      this.tabContainer.parentNode.insertBefore(
    ...
    if (this.isOffline(true)) {
      ...
      if (file != null) {
        if (file.invalidChecksum) {
          ...
          file.sync != null &&
          (!file.sync.enabled || !file.sync.isRealtimeActive()) &&
          this.getServiceName() != 'atlassian'
        ) {
          // Atlassian app has pulling sync (no RT)
          status =
            mxResources.get('realtimeCollaboration') +
            ': ' +
            mxResources.get('disabled')
        } else if (file.sync != null && !file.sync.isConnected()) {
          status = mxResources.get('notConnected')
        } else if (
          file.isRealtimeEnabled() &&
  ...
  EditorUi.prototype.createMenubarForTheme = function (value) {
    ...
    if (elt != null) {
      ...
      this.menubarContainer.parentNode.insertBefore(elt, this.menubarContainer)
    }
  ...
  EditorUi.prototype.createMenuItem = function (key, img, ignoreState) {
    ...
    var btn = this.createToolbarButton(
      img,
      mxResources.get(key) +
    ...
    if (this.formatWindow == null) {
      ...
      var h =
        urlParams['embedInline'] == '1'
          ...
          : urlParams['sketch'] == '1'
          ? 580
          : Math.min(566, this.editor.graph.container.clientHeight - 10)
      ...
      this.formatWindow.window.addListener(
        mxEvent.SHOW,
        mxUtils.bind(this, function () {
      ...
      this.formatWindow.window.toggleMinimized = function () {
        ...
        if (this.minimized) {
          ...
          this.div.style.left =
            Math.max(0, parseInt(this.div.style.left) - w + 140) + 'px'
        }
      ...
      mxEvent.addListener(
        this.formatWindow.window.title,
        'dblclick',
        mxUtils.bind(this, function (evt) {
  ...
  EditorUi.prototype.toggleFormatPanel = function (visible) {
    ...
    if (wnd != null) {
      wnd.window.setVisible(
        visible != null ? visible : !this.isFormatPanelVisible()
      )
    } else {
  ...
  EditorUi.prototype.toggleShapesPanel = function (visible) {
    if (this.isShapesPanelVisible() != visible) {
      ...
      mxUtils.setPrefixedStyle(
        ...
        'transform',
        tmp == 0 ? 'translateX(0)' : 'translateX(-100%)'
      )
      ...
      window.setTimeout(
        mxUtils.bind(this, function () {
          mxUtils.setPrefixedStyle(
            this.sidebarContainer.style,
            'transform',
            tmp == 0 ? 'translateX(-100%)' : 'translateX(0)'
          )
          mxUtils.setPrefixedStyle(
            this.sidebarContainer.style,
            'transition',
            'transform ' + delay + 's ease-in-out'
          )
          mxUtils.setPrefixedStyle(
            this.sidebarContainer.style,
            'transform-origin',
  ...
  EditorUi.prototype.createShapesPanel = function (container) {
    var css =
      'position:absolute;border-width:1px;cusor:pointer;border-style:none;' +
  ...
  EditorUi.prototype.createShapesWindow = function () {
    if (this.sidebarWindow == null) {
      ...
      this.sidebarWindow = new WrapperWindow(
        this,
        ...
        simpleTheme && urlParams['embedInline'] != '1'
          ? Math.max(
              30,
              (this.diagramContainer.parentNode.clientHeight - h) / 2
            )
          : 56,
        w - 6,
        h - 6,
      ...
      this.sidebarWindow.window.addListener(
        mxEvent.SHOW,
        mxUtils.bind(this, function () {
    ...
    return (
      (Editor.isDarkMode()
        ? 'html body .geMenubarContainer .geMenuItem .geMenuItem, html body .geMenubarContainer a.geMenuItem { color: #353535; }' +
          ...
          'html > body.geEditor > div > a.geItem { background-color: ' +
          Editor.darkColor +
          '; color: #cccccc; border-color: #505759; }' +
      ...
      (EditorUi.isElectronApp ? 'app-region: no-drag; ' : '') +
      '}' +
      ...
      'html table.mxPopupMenu td.mxPopupMenuItem { color: ' +
      (Editor.isDarkMode() ? '#cccccc' : '#353535') +
      '; font-size: 14px; padding-top: 4px; padding-bottom: 4px; }' +
      'html table.mxPopupMenu tr.mxPopupMenuItemHover { background-color: ' +
      (Editor.isDarkMode() ? '#000000' : '#29b6f2') +
      '; }' +
      'html tr.mxPopupMenuItemHover td.mxPopupMenuItem, html tr.mxPopupMenuItemHover td.mxPopupMenuItem span { color: ' +
      (Editor.isDarkMode() ? '#cccccc' : '#ffffff') +
      ' !important; }' +
  ...
  EditorUi.prototype.isHighContrast = function () {
    var highContrastStylesheet = document.getElementById(
  ...
  EditorUi.prototype.setHighContrast = function (value) {
    ...
    if (highContrastStylesheet != null && window.matchMedia) {
      ...
      if (on && !value) {
        highContrastStylesheet.setAttribute(
          'media',
          match ? 'not all' : '(forced-colors: active)'
        )
      } else if (!on && value) {
        highContrastStylesheet.setAttribute(
          'media',
          match ? '(forced-colors: active)' : 'all'
        )
      }
    }
  }
      ...
      var delayed = mxUtils.bind(this, function () {
        if (Editor.darkMode != value) {
          ...
          if (window.StyleFormatPanel != null) {
            StyleFormatPanel.prototype.defaultStrokeColor = Editor.isDarkMode()
              ? '#cccccc'
              : 'black'
          }

          if (window.Format != null) {
            Format.inactiveTabBackgroundColor = Editor.isDarkMode()
              ? '#000000'
              : '#e4e4e4'
          }

          mxConstants.DROP_TARGET_COLOR = Editor.isDarkMode()
            ? '#00ff00'
            : '#0000FF'
          Editor.checkmarkImage =
            Editor.isDarkMode() && mxClient.IS_SVG
  ...
  EditorUi.prototype.inlineSizeChanged = function () {
    ...
    if (Editor.inlineFullscreen) {
      ...
      if (this.diagramContainer.getAttribute('data-bounds') == null) {
        this.diagramContainer.setAttribute(
          'data-bounds',
          this.diagramContainer.style.top +
            ' ' +
      ...
      if (bounds != null) {
        ...
        w = Math.min(
          this.minInlineWidth != null ? Math.max(this.minInlineWidth, w) : w,
          ds.width - 80
        )
        h = Math.min(
          this.minInlineHeight != null ? Math.max(this.minInlineHeight, h) : h,
          ds.height - 80
        )
      ...
      toolbar.style.top =
        this.diagramContainer.offsetTop - toolbar.offsetHeight - 4 + 'px'

      picker.style.display = ''
      picker.style.left =
        this.diagramContainer.offsetLeft - picker.offsetWidth - 4 + 'px'
      picker.style.top = this.diagramContainer.offsetTop + 'px'

      footer.style.left =
        this.diagramContainer.offsetLeft +
      ...
      this.bottomResizer.style.left =
        this.diagramContainer.offsetLeft +
        (this.diagramContainer.offsetWidth - this.bottomResizer.offsetWidth) /
          2 +
        'px'
      this.bottomResizer.style.top =
        this.diagramContainer.offsetTop +
        this.diagramContainer.offsetHeight -
        this.bottomResizer.offsetHeight / 2 -
        1 +
        'px'
      ...
      this.rightResizer.style.left =
        this.diagramContainer.offsetLeft +
        this.diagramContainer.offsetWidth -
        this.rightResizer.offsetWidth / 2 -
        1 +
        'px'
      this.rightResizer.style.top =
        this.diagramContainer.offsetTop +
        (this.diagramContainer.offsetHeight - this.bottomResizer.offsetHeight) /
          2 +
        'px'
    }
  ...
  EditorUi.prototype.updateDefaultStyles = function () {
    ...
    if (
      Editor.config == null ||
      (Editor.config.defaultVertexStyle == null &&
    ...
    if (Editor.config == null || Editor.config.defaultFonts == null) {
      ...
      if (
        ...
        if (Editor.sketchMode) {
          ...
          setStyle(
            graph.defaultVertexStyle,
            'curveFitting',
            Editor.sketchDefaultCurveFitting
          )
          setStyle(
            graph.defaultVertexStyle,
            'jiggle',
            Editor.sketchDefaultJiggle
          )
      ...
      if (Editor.currentTheme == 'sketch') {
        this.menus.defaultFonts = Menus.prototype.defaultFonts.concat(
          Editor.sketchFonts
        )
      } else {
  ...
  EditorUi.prototype.installSettings = function () {
    if (Editor.isSettingsEnabled()) {
       ...
       */
      this.editor.graph.connectionHandler.setCreateTarget(
        mxSettings.isCreateTarget()
      )
      ...
      this.addListener(
        'copyConnectChanged',
        mxUtils.bind(this, function (sender, evt) {
          mxSettings.setCreateTarget(
            this.editor.graph.connectionHandler.isCreateTarget()
          )
          mxSettings.save()
        })
      )
      ...
      this.editor.graph.pageFormat =
        this.editor.graph.defaultPageFormat != null
          ? this.editor.graph.defaultPageFormat
      ...
      this.editor.graph.view.defaultDarkGridColor =
        mxSettings.getGridColor(true)
      ...
      if (this.sidebar != null) {
        if (
          ...
          this.sidebar.searchShapes != null
        ) {
  ...
  EditorUi.prototype.copyImage = function (cells, xml, scale) {
    try {
      if (
        ...
        this.editor.exportToCanvas(
          mxUtils.bind(this, function (canvas, svgRoot) {
            try {
              this.spinner.stop()
   ...
   * Creates the format panel and adds overrides.
   */
  EditorUi.prototype.pasteXml = function (
    xml,
    pasteAsLabel,
    compat,
    evt,
   ...
   * Creates the format panel and adds overrides.
   */
  EditorUi.prototype.pasteCells = function (
    evt,
    realElt,
    useEvent,
    pasteAsLabel
    ...
    if (!mxEvent.isConsumed(evt)) {
      ...
      if (useEvent && evt.clipboardData != null && evt.clipboardData.getData) {
        ...
        if (
          plain != null &&
          plain.length > 0 &&
          plain.substring(0, 18) == '%3CmxGraphModel%3E'
        ) {
          try {
      ...
      /*else if (spans != null && spans.length > 0 && spans[0].hasAttribute('data-meta')
        ...
        try {
          ...
          if (
            tmp &&
            (this.isCompatibleString(tmp) ||
              tmp
                .substring(0, 20)
                .replace(/\s/g, '')
                .indexOf('{"isProtected":') == 0)
          ) {
            compat = true
            xml = tmp
          }
  ...
  EditorUi.prototype.showPrintDialog = function (title, fn) {
    ...
    this.showDialog(
      new PrintDialog(this, title, fn).container,
      320,
      h,
      true,
      true
  ...
  EditorUi.prototype.print = function (preview, args) {
    ...
    var printGraph = mxUtils.bind(
      this,
      function (thisGraph, pv, forcePageBreaks, pageId) {
        ...
        if (pv == null) {
          ...
          pv.writeHead = function (doc) {
            ...
            if (editor.fontCss != null) {
              doc.writeln('<style type="text/css">')
              doc.writeln(
                mxUtils.htmlEntities(editor.fontCss, false, false, false)
              )
              doc.writeln('</style>')
            }
          ...
          if (Editor.enableCssDarkMode) {
            ...
            pv.getBackgroundImage = function () {
              return graph.adaptBackgroundPage(
                printGetBackgroundImage.apply(this, arguments)
              )
            }
          }
    ...
    if (ignorePages) {
      ignorePages =
        args.selection || (pagesFrom == currentPage && pagesTo == currentPage)
    }
      ...
      for (var i = i0; i <= imax; i++) {
        ...
        if (tempGraph == null) {
          ...
          if (bgImage != null && bgImage.originalSrc != null) {
            bgImage = this.createImageForPageLink(bgImage.originalSrc, page)
          }
    ...
    if (pv == null || pv.wnd == null) {
      ...
      if (pv.mathEnabled) {
        ...
        doc.writeln(
          '<script type="text/javascript" src="js/math-print.js"></script>'
        )
      }
          ...
          mxUtils.bind(this, function (evt) {
            if (this.editor.graph.isEnabled() || urlParams['embed'] != '1') {
              ...
              if (
                dropElt == null &&
                (!mxClient.IS_IE ||
                  (document.documentMode > 10 && document.documentMode < 12))
              ) {
                ...
                if (data == null) {
                  ...
                  if (provider != null) {
                    if (
                      ...
                      if (
                        mxUtils.indexOf(provider.types, 'text/uri-list') >= 0
                      ) {
                    ...
                    if (data != null) {
                      ...
                      if (Editor.isPngDataUrl(data)) {
                        ...
                        if (this.isOffline()) {
                          ...
                          new mxXmlRequest(
                            OPEN_URL,
                            'format=xml&data=' + encodeURIComponent(data)
                          ).send(
                            mxUtils.bind(this, function (req) {
                              if (
                                req.getStatus() >= 200 &&
  ...
  EditorUi.prototype.openFileHandle = function (
    ...
    if (name != null && name.length > 0) {
      if (
        (!this.useCanvasForExport && /(\.png)$/i.test(name)) ||
        /(\.pdf)$/i.test(name)
      ) {
   ...
   */
  EditorUi.prototype.openLocalFile = function (
    data,
    name,
    temp,
    fileHandle,
  ...
  EditorUi.prototype.setGraphEnabled = function (enabled) {
    ...
    this.hsplit.style.display =
      enabled && Editor.currentTheme != 'sketch' && Editor.currentTheme != 'min'
        ? ''
        : 'none'
    ...
    if (parent != window) {
      if (
        ...
        this.installMessageHandler(
          mxUtils.bind(this, function (xml, evt, modified, convertToSketch) {
            if (!initialized) {
              initialized = true
  ...
  EditorUi.prototype.showLayersDialog = function () {
    if (
      this.editor.graph
        .getModel()
        .getChildCount(this.editor.graph.getModel().getRoot()) > 1
    ) {
      if (this.actions.layersWindow == null) {
  ...
  EditorUi.prototype.createLoadMessage = function (eventName) {
    ...
    return {
      ...
      page: graph.view.getBackgroundPageBounds()
    }
  }
  ...
  EditorUi.prototype.sendEmbeddedSvgExport = function (noExit) {
    try {
      ...
      if (!this.editor.modified) {
        if (!noExit) {
          parent.postMessage(
            JSON.stringify({ event: 'exit', point: this.embedExitPoint }),
            '*'
          )
        }
      } else {
  ...
  EditorUi.prototype.installMessageHandler = function (fn) {
    ...
    var updateStatus = mxUtils.bind(this, function (sender, eventObject) {
      if (!this.editor.modified || urlParams['modified'] == '0') {
        ...
        this.editor.setStatus(
          mxUtils.htmlEntities(mxResources.get(urlParams['modified']))
        )
      }
    })
    ...
    mxEvent.addListener(
      ...
      mxUtils.bind(this, function (evt) {
          ...
          if (
            ...
            try {
              if (Editor.isPngDataUrl(data)) {
                ...
                data.substring(0, 26) == 'data:image/svg+xml;base64,'
              ) {
        ...
        if (urlParams['proto'] == 'json') {
          ...
          try {
            if (data == null) {
              ...
              this.showError(
                data.titleKey != null
                  ? mxResources.get(data.titleKey)
                  : data.title,
                data.messageKey != null
                  ? mxResources.get(data.messageKey)
                  : mxUtils.htmlEntities(data.message),
                data.buttonKey != null
                  ? mxResources.get(data.buttonKey)
                  : data.button
              )
              ...
              var dlg = new FilenameDialog(
                ...
                function (value) {
                  if (value != null) {
                    ...
                    parent.postMessage(
                      JSON.stringify({ event: 'prompt-cancel', message: data }),
                      '*'
                    )
                  }
                },
              ...
              var dlg = new NewDialog(
                this,
                false,
                data.templatesOnly ? false : data.callback != null,
                ...
                null,
                enableRecentDocs
                  ? mxUtils.bind(this, function (recentReadyCallback) {
                      this.remoteInvoke(
                        'getRecentDiagrams',
                        [null],
                        null,
                ...
                enableSearchDocs
                  ? mxUtils.bind(
                      this,
                      function (searchStr, searchReadyCallback) {
                        this.remoteInvoke(
                          'searchDiagrams',
                          [searchStr, null],
                          null,
                ...
                null,
                enableCustomTemp
                  ? mxUtils.bind(this, function (customTempCallback) {
                      this.remoteInvoke(
                        'getCustomTemplates',
                        null,
                        null,
              ...
              if (data.messageKey != null) {
                this.editor.setStatus(
                  mxUtils.htmlEntities(mxResources.get(data.messageKey))
                )
              ...
              try {
                var temp =
                  this.diagramContainer.getAttribute('data-scrollState')
              ...
              if (data.format == 'png' || data.format == 'xmlpng') {
                if (
                  (data.spin == null && data.spinKey == null) ||
                  this.spinner.spin(
                    document.body,
                    data.spinKey != null
                      ? mxResources.get(data.spinKey)
                      : data.spin
                  )
                ) {
                  ...
                  var processUri = mxUtils.bind(this, function (uri) {
                    ...
                    if (data.format == 'xmlpng') {
                      uri = Editor.writeGraphModelToPng(
                        uri,
                        'tEXt',
                        'mxfile',
                        encodeURIComponent(xml)
                  ...
                  if (this.isExportToCanvas()) {
                    var graphReady = mxUtils.bind(this, function () {
                      ...
                      if (data.layerIds != null) {
                        ...
                        var layers = graphModel.getChildCells(
                          graphModel.getRoot()
                        )
                        var layerIdsMap = {}
                        ...
                        for (var i = 0; i < layers.length; i++) {
                          graphModel.setVisible(
                            layers[i],
                            layerIdsMap[layers[i].id] || false
                          )
                        }
                      }
                      ...
                      if (data.keepTheme) {
                        theme =
                          Editor.cssDarkMode || Editor.isDarkMode()
                            ? 'dark'
                            : 'light'
                      }
                    ...
                    var req = new mxXmlRequest(
                      ...
                      'format=png&embedXml=' +
                        ...
                        (data.layerIds != null && data.layerIds.length > 0
                          ? '&extras=' +
                            encodeURIComponent(
                              JSON.stringify({ layerIds: data.layerIds })
                            )
                          : '') +
                    ...
                    if (data.format == 'xmlsvg') {
                      ...
                      if (
                        ...
                        var svgRoot = this.editor.graph.getSvg(
                          ...
                          null,
                          null,
                          this.editor.graph.shadowVisible || data.shadow,
                          null,
                          theme
                        )
              ...
              if (
                data.saveAndExit != null &&
                urlParams['saveAndExit'] == null
              ) {
              ...
              if (data.rect != null) {
                ...
                this.diagramContainer.style.left =
                  Math.max(60, data.rect.left) + 'px'
                this.diagramContainer.style.top =
                  Math.max(40, data.rect.top) + 'px'
                ...
                afterLoad = mxUtils.bind(this, function () {
                  var ds = mxUtils.getDocumentSize()
                  w = Math.min(
                    this.minInlineWidth != null
                      ? Math.max(this.minInlineWidth, w)
                      : w,
                    ds.width - 80
                  )
                  var h = Math.min(
                    this.minInlineHeight != null
                      ? Math.max(this.minInlineHeight, h0)
                      : h0,
                    ds.height - 80
                  )
                  ...
                  window.setTimeout(
                    mxUtils.bind(this, function () {
                      this.fireEvent(
                        new mxEventObject('editInlineStart', 'data', [data])
                      )
                      graph.container.focus()
              ...
              if (data.title != null && this.buttonContainer != null) {
                ...
                if (this.embedFilenameSpan != null) {
                  this.embedFilenameSpan.parentNode.removeChild(
              ...
              if (file != null) {
                ...
                if (tmp != null && tmp != '') {
                  file.mergeFile(
                    new LocalFile(this, tmp),
                    function () {
                      parent.postMessage(
                        JSON.stringify({ event: 'merge', message: data }),
                        '*'
                      )
                    },
                    function (err) {
        ...
        if (
          data != null &&
          typeof data.substring === 'function' &&
          data.substring(0, 34) == 'data:application/vnd.visio;base64,'
        ) {
          // Checks VND binary magic number in base64
          var filename =
            data.substring(34, 45) == '0M8R4KGxGuE' ? 'raw.vsd' : 'raw.vsdx'

          this.importVisio(
            this.base64ToBlob(data.substring(data.indexOf(',') + 1)),
            function (xml) {
              doLoad(xml, evt)
            },
            mxUtils.bind(this, function (e) {
   ...
   * Adds the buttons for embedded mode.
   */
  EditorUi.prototype.createEmbedButton = function (
    title,
    fn,
    shortcut,
    primary
    ...
    if (modern) {
      ...
      btn.className = 'geBigButton' + (!primary ? ' geBigStandardButton' : '')
    }
  ...
  EditorUi.prototype.addEmbedButtons = function () {
    ...
    if (urlParams['noSaveBtn'] == '1') {
      if (urlParams['saveAndExit'] != '0') {
        div.appendChild(
          this.createEmbedButton(
            urlParams['publishClose'] == '1'
              ? mxResources.get('publish')
              : mxResources.get('saveAndExit'),
  ...
  EditorUi.prototype.showImportCsvDialog = function () {
    ...
    this.showDialog(
      this.importCsvDialog.container,
      640,
      520,
      true,
      true,
  ...
  EditorUi.prototype.showCustomLayoutDialog = function (value) {
    this.loadOrgChartLayouts(
      mxUtils.bind(this, function () {
        var dlg = new TextareaDialog(
          this,
          mxResources.get('layout'),
          value,
          mxUtils.bind(this, function (newValue) {
            if (newValue.length > 0) {
              try {
          ...
          null,
          null,
          mxUtils.bind(this, function (buttons, input) {
            var copyBtn = mxUtils.button(
  ...
  EditorUi.prototype.loadOrgChartLayouts = function (fn) {
    this.createTimeout(
      ...
      mxUtils.bind(this, function (timeout) {
        ...
        if (
          typeof mxOrgChartLayout === 'undefined' &&
          !this.loadingOrgChart &&
          !this.isOffline(true)
        ) {
          if (this.spinner.spin(document.body, mxResources.get('loading'))) {
            ...
            if (urlParams['dev'] == '1') {
              ...
              mxscript(
                window.DRAWIO_SERVER_URL + 'js/orgchart.min.js',
                onload,
                null,
                null,
                null,
      ...
      if (lines.length > 0) {
        ...
        while (index < lines.length && lines[index].charAt(0) == '#') {
          ...
          while (
            ...
            text =
              ...
              mxUtils.trim(lines[index].substring(1))
            index++
          }
        ...
        try {
          for (var i = 0; i < arrays.length; i++) {
            ...
            var cell = null
            var id =
              identityIndex != null ? namespace + values[identityIndex] : null
            ...
            if (id != null) {
              ...
              ignoreCell = cell == null || mxUtils.indexOf(allCells, cell) >= 0
            }

            var newCell = new mxCell(
              label,
              new mxGeometry(x0, y, 0, 0),
            ...
            newCell.style = graph.replacePlaceholders(
              newCell,
              newCell.style,
              vars
            )
            ...
            if (cell != null && !ignoreCell) {
              ...
              graph.fireEvent(
                new mxEventObject('cellsInserted', 'cells', [newCell])
              )
            }
            ...
            var parent =
              parentIndex != null
                ? graph.model.getCell(namespace + values[parentIndex])
                : null
            ...
            if (cell.vertex) {
              ...
              var widthValue =
                width.charAt(0) == '@'
                  ? cell.getAttribute(width.substring(1))
                  : null

              if (widthValue != null && widthValue != 'auto') {
                cell.geometry.width = parseFloat(
                  cell.getAttribute(width.substring(1))
                )
              } else {
                cell.geometry.width =
                  width == 'auto' || widthValue == 'auto'
                    ? size.width + padding
                    : parseFloat(width)
              }
              ...
              var heightValue =
                height.charAt(0) == '@'
                  ? cell.getAttribute(height.substring(1))
                  : null
            ...
            if (!exists) {
              ...
              if (parent != null) {
                parent.style = graph.replacePlaceholders(
                  parent,
                  parentstyle,
                  vars
                )
          ...
          for (var i = 0; i < parents.length; i++) {
            var widthValue =
              width.charAt(0) == '@'
                ? parents[i].getAttribute(width.substring(1))
                : null
            var heightValue =
              height.charAt(0) == '@'
                ? parents[i].getAttribute(height.substring(1))
                : null
          ...
          for (var e = 0; e < edges.length; e++) {
            ...
            for (var i = 0; i < allCells.length; i++) {
              ...
              var insertEdge = mxUtils.bind(
                this,
                function (realCell, dataCell, edge) {
                  ...
                  if (tmp != null && tmp != '') {
                    ...
                    for (var j = 0; j < refs.length; j++) {
                      ...
                      if (ref == null && unknownStyle != null) {
                        ref = new mxCell(
                          refs[j],
                          new mxGeometry(x0, y0, 0, 0),
                          unknownStyle
                        )
                        ref.style = graph.replacePlaceholders(
                          dataCell,
                          ref.style,
                          vars
                        )
                        var refSize =
                          this.editor.graph.getPreferredSizeForCell(ref)
                      ...
                      if (ref != null) {
                        ...
                        var placeholders =
                          (edge.placeholders == 'target') == !edge.invert
                            ? ref
                            : realCell
                        var edgeStyle =
                          edge.style != null
                          ...
                          for (var k = 0; k < edge.labels.length; k++) {
                            ...
                            if (def.placeholders != null) {
                              el.value = graph.replacePlaceholders(
                                (def.placeholders == 'target') == !edge.invert
                                  ? ref
                                  : realCell,
                                el.value,
                                vars
          ...
          if (cells.length > 0) {
            ...
            if (layout.charAt(0) == '[') {
              ...
              this.executeLayouts(
                graph.createLayouts(JSON.parse(layout)),
                function () {
                  postProcess()
                  temp()
                }
              ...
              circleLayout.isVertexIgnored = function (vertex) {
                return (
                  circleLayoutIsVertexIgnored.apply(this, arguments) ||
              ...
              layout == 'verticaltree' ||
              (layout == 'auto' &&
                select.length == 2 * cells.length - 1 &&
                roots.length == 1)
            ) {
              // Required for layouts to work with new cells
              graph.view.validate()

              var treeLayout = new mxCompactTreeLayout(
                graph,
                layout == 'horizontaltree'
              )
              ...
              var orgChartLayout = new mxOrgChartLayout(
                graph,
                2,
                levelspacing,
                nodespacing
              ...
              orgChartLayout.isVertexIgnored = function (vertex) {
                return (
                  orgChartLayoutIsVertexIgnored.apply(this, arguments) ||
                  mxUtils.indexOf(cells, vertex) < 0
                )
              }
              ...
              layout == 'organic' ||
              (layout == 'auto' && select.length > cells.length)
            ) {
              // Required for layouts to work with new cells
              graph.view.validate()
              ...
              organicLayout.isVertexIgnored = function (vertex) {
                return (
                  organicLayoutIsVertexIgnored.apply(this, arguments) ||
                  mxUtils.indexOf(cells, vertex) < 0
                )
              }
  ...
  EditorUi.prototype.updateUi = function () {
    ...
    var libsEnabled = urlParams['embed'] != '1' || this.editor.graph.isEnabled()
    ...
    autoModeAction.setEnabled(
      autoModeAction.isEnabled() && Editor.currentTheme != 'atlas'
    )
  ...
  EditorUi.prototype.updateActionStates = function () {
    ...
    this.actions
      .get('autosave')
      .setEnabled(
        file != null && file.isEditable() && file.isAutosaveOptional()
      )
    this.actions.get('guides').setEnabled(active)
    this.actions.get('editData').setEnabled(graph.isEnabled())
    this.actions
      .get('editConnectionPoints')
      .setEnabled(active && ss.edges.length == 0 && ss.vertices.length == 1)
    this.actions
      .get('editImage')
      .setEnabled(active && ss.image && ss.cells.length > 0)
    this.actions
      .get('crop')
      .setEnabled(active && ss.image && ss.cells.length > 0)
    ...
    this.actions
      .get('copyStyle')
      .setEnabled(active && !graph.isSelectionEmpty())
    this.actions
      .get('pasteStyle')
      .setEnabled(this.copiedStyle != null && active && ss.cells.length > 0)
    ...
    this.actions
      .get('makeCopy')
      .setEnabled(file != null && !file.isRestricted())
    this.actions
      .get('editDiagram')
      .setEnabled(active && (file == null || !file.isRestricted()))
    this.actions
      .get('publishLink')
      .setEnabled(file != null && !file.isRestricted())
    this.actions
      .get('removeFormat')
      .setEnabled(
        graph.isEnabled() && !graph.isSelectionEmpty() && !graph.isEditing()
      )
    this.actions
      .get('tags')
      .setEnabled(this.diagramContainer.style.visibility != 'hidden')
    this.actions
      .get('layers')
      .setEnabled(this.diagramContainer.style.visibility != 'hidden')
    this.actions
    ...
    this.actions
      .get('rename')
      .setEnabled(
        (file != null && file.isRenamable()) || urlParams['embed'] == '1'
      )
    ...
    findReplace.label =
      ...
      (graph.isEnabled() ? '/' + mxResources.get('replace') : '')
  ...
  if (window.ExportDialog != null) {
    ...
    ExportDialog.exportFile = function (
      editorUi,
      name,
      format,
      bg,
  ...
  EditorUi.prototype.getDiagramTextContent = function () {
    ...
    if (this.pages != null) {
      for (var i = 0; i < this.pages.length; i++) {
        ...
        allPagesTxt +=
          this.pages[i].getName() + ' ' + pageGraph.getIndexableText() + ' '
      }
    } else {
  ...
  EditorUi.prototype.showRemotelyStoredLibrary = function (title) {
    ...
    libsSection.style.cssText =
      'border:1px solid lightGray;overflow: auto;height:300px'
      ...
      function (libsList) {
        ...
        if (libsList.length == 0) {
          libsSection.innerHTML =
            ...
            mxUtils.htmlEntities(mxResources.get('noLibraries')) +
            '</div>'
        } else {
    ...
    var dlg = new CustomDialog(
        ...
        for (var id in selectedLibs) {
          ...
          mxUtils.bind(this, function (lib) {
            this.remoteInvoke(
              ...
              [lib.downloadUrl],
              null,
              mxUtils.bind(this, function (libContent) {
                pendingLibs--
      ...
      null,
      null,
      'https://www.drawio.com/doc/faq/custom-libraries-confluence-cloud'
    )
    this.showDialog(
      dlg.container,
      340,
  ...
  EditorUi.prototype.handleRemoteInvokeResponse = function (msg) {
    ...
    if (callback == null) {
      throw new Error(
        'No callback for ' +
          (msgMarkers != null ? msgMarkers.callbackId : 'null')
      )
    } else if (msg.error) {
  ...
  EditorUi.prototype.remoteInvoke = function (
    remoteFn,
    remoteFnArgs,
    msgMarkers,
    callback,
    ...
    if (this.remoteWin != null) {
      //remote invoke is ready
      ...
      if (functionInfo != null && typeof this[funtionName] === 'function') {
        if (functionInfo.allowedDomains) {
          ...
          if (!allowed) {
            sendResponse(
              null,
              'Invalid Call: ' + funtionName + ' is not allowed.'
            )
            return
          }
        }
        ...
        try {
          ...
          req.onsuccess = mxUtils.bind(this, function (e) {
            try {
              ...
              if (
                location.host == 'app.diagrams.net' &&
                !this.drawioMigrationStarted
              ) {
                this.drawioMigrationStarted = true

                this.getDatabaseItem(
                  '.drawioMigrated3',
                  mxUtils.bind(this, function (value) {
                    if (value && urlParams['forceMigration'] != '1') {
                      //Already migrated
                      return
                    }
                    ...
                    drawioFrame.setAttribute(
                      'src',
                      'https://www.draw.io?embed=1&proto=json&forceMigration=' +
                        urlParams['forceMigration']
                    )
                      ...
                      try {
                        ...
                        StorageFile.getFileContent(
                          ...
                          mxUtils.bind(this, function (data) {
                            if (
                              data == null ||
                              (fileTitle == '.scratchpad' &&
                                data == this.emptyLibraryXml)
                            ) {
                              //Don't overwrite
                              drawioFrame.contentWindow.postMessage(
                                JSON.stringify({
                    ...
                    var messageListener = mxUtils.bind(this, function (evt) {
                      try {
                        ...
                        if (drawMsg.event == 'init') {
                          ...
                          drawMsg.event == 'remoteInvokeResponse' &&
                          !allDone
                        ) {
                          if (collectNames) {
                            if (
                              drawMsg.resp != null &&
                              drawMsg.resp.length > 0 &&
                              drawMsg.resp[0] != null
                            ) {
   ...
   */
  EditorUi.prototype.setDatabaseItem = function (
    key,
    data,
    success,
    error,
      ...
      mxUtils.bind(this, function (db) {
        try {
          ...
          for (var i = 0; i < storeName.length; i++) {
            trx
              .objectStore(storeName[i])
              .put(
                key != null && key[i] != null
                  ? { key: key[i], data: data[i] }
                  : data[i]
              )
          }
        } catch (e) {
   ...
   */
  EditorUi.prototype.removeDatabaseItem = function (
    key,
    success,
    error,
    storeName
   ...
   */
  EditorUi.prototype.getDatabaseItem = function (
    key,
    success,
    error,
    storeName
   ...
   */
  EditorUi.prototype.getDatabaseItemKeys = function (
    success,
    error,
    storeName
  ) {
  ...
  //===========To Be Removed Soon==========
  EditorUi.prototype.loadUrl = function (
    url,
    success,
    error,
    forceBinary,
  ...
  EditorUi.prototype.exportToCanvas = function (
    callback,
    width,
    imageCache,
    background,
    ...
    return this.editor.exportToCanvas(
      callback,
      width,
      imageCache,
      background,
  ...
  EditorUi.prototype.convertImages = function (
    svgRoot,
    callback,
    imageCache,
    converter
  ...
  EditorUi.prototype.writeGraphModelToPng = function (
    data,
    type,
    key,
    value,
  ...
  EditorUi.prototype.getLocalStorageFileNames = function () {
    if (
      localStorage.getItem('.localStorageMigrated') == '1' &&
      urlParams['forceMigration'] != '1'
    ) {
      return null
    }
    ...
    for (var i = 0; i < localStorage.length; i++) {
      ...
      if (
        key.length > 0 &&
        (key == '.scratchpad' || key.charAt(0) != '.') &&
        value.length > 0
      ) {
        var isFile =
          value.substring(0, 8) === '<mxfile ' ||
          value.substring(0, 5) === '<?xml' ||
          value.substring(0, 12) === '<!--[if IE]>'
  ...
  EditorUi.prototype.getLocalStorageFile = function (key) {
    ...
    return {
      title: key,
      data: value,
      isLib: value.substring(0, 11) === '<mxlibrary>'
    }
  }
...
var CommentsWindow = function (editorUi, x, y, w, h, saveCallback) {
  ...
  div.style.background = Editor.isDarkMode() ? Editor.darkColor : 'whiteSmoke'
  ...
  function addComment(comment, parentArr, parent, level, showResolved) {
    ...
    userImg.src =
      comment.user != null && comment.user.pictureUrl != null
              ...
              function (markedOnly) {
                if (markedOnly === true) {
                  ...
                  noComments.style.display =
                    listDiv.getElementsByTagName('div').length == 0
                      ? 'block'
                      : 'none'
                }
              },
    ...
    if (!readOnly && !comment.isLocked && level == 0) {
      //Resolve is a top-level action only
      function toggleResolve(evt) {
        function doToggle() {
          ...
          mxUtils.write(
            resolveActionLnk,
            comment.isResolved
              ? mxResources.get('reopen')
              : mxResources.get('resolve')
          )
          var actionsDisplay = comment.isResolved ? 'none' : ''
          var replies = collectReplies(comment).replies
          var color = Editor.isDarkMode()
            ? 'transparent'
            : comment.isResolved
            ? 'ghostWhite'
            : 'white'
    ...
    if (curEdited != null) {
      if (curEdited.comment.id == comment.id) {
        ...
        editComment(
          comment,
          cdiv,
          curEdited.saveCallback,
          curEdited.deleteOnCancel
        )
        comment.content = origContent
      } else if (
        curEdited.comment.id == null &&
        curEdited.comment.pCommentId == comment.id
      ) {
  ...
  resolvedLink.innerHTML =
    '<img class="geAdaptiveAsset" src="' +
    IMAGE_PATH +
    '/check.png" style="width: 16px; padding: 2px;">'
  ...
  if (editorUi.commentsRefreshNeeded()) {
    ...
    refreshLink.innerHTML =
      '<img class="geAdaptiveAsset" src="' +
      IMAGE_PATH +
      '/update16.png" style="width: 16px; padding: 2px;">'
  ...
  if (editorUi.commentsSaveNeeded()) {
    ...
    saveLink.innerHTML =
      '<img src="' +
      IMAGE_PATH +
      '/save.png" style="width: 20px; padding: 2px;">'
  ...
  var refresh = mxUtils.bind(this, function () {
    ...
    if (curEdited != null) {
      try {
        ...
        var commentEditTxt = curEdited.div.querySelector(
      ...
      editorUi.getComments(
        function (list) {
          ...
          if (
            curEdited != null &&
            curEdited.comment.id == null &&
            curEdited.comment.pCommentId == null
          ) {
            listDiv.appendChild(curEdited.div)
            editComment(
              curEdited.comment,
        ...
        mxUtils.bind(this, function (err) {
          listDiv.innerHTML = mxUtils.htmlEntities(
            mxResources.get('error') +
...
var ConfirmDialog = function (
  ...
  var cancelBtn = mxUtils.button(
    cancelLabel || mxResources.get('cancel'),
    function () {
      editorUi.hideDialog()
